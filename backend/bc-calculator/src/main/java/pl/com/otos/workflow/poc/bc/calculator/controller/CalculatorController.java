...
public class CalculatorController {
    ...
    public CalculatorResponse finishTask(@RequestBody CalculatorRequest request) {
        FinishCalculatorTask finishCalculatorTaskDto = new FinishCalculatorTask("calculator",request.processId(), request.taskId(), new CalculatorPayload(request.amount()));
